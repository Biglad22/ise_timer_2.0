...
export default function page() {
  return (
    <div>
      {/* HERO SECTION */}
      <section
        className={`w-screen h-screen px-parent-margin py-6 bg-[url(${images.hero_sec_bg})]`}
      >
        <h2 className="font-semibold">Ise Timer</h2>
      </section>
      <section className="w-screen h-screen px-parent-margin py-6 bg-background">
        <h4 className=" capitalize font-semibold mb-6">how it works</h4>
